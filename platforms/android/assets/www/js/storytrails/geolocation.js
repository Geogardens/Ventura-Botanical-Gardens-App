...
function startGeolocation() {
    ...
    if (navigator.geolocation) {
        ...
        //accuracyRadiusListener = setInterval(function () { radius = currentLocation.coords.accuracy; }, radiusInterval * 1000);
    }
            ...
            if (typeof (stopInDistance) != "undefined" && stopInDistance != null) {
                ...
                if (appProfile.currentStop == null || appProfile.currentStop.orderId != stopInDistance.orderId) {
                    ...
                    if (inForeground == true) {
                        ...
                        //"Approaching Stop #" + stopInDistance.orderId,
                        //goToStop(appProfile.currentTour.tag, stopInDistance.orderId),
                        //"Guided Tour Alert",
                        //"OK"
                        //    );
...
function watchLocation(location) {
    try {
        ...
        //if (location.coords.accuracy <= 5000) {
            //konsole.log("Accuracy  " + location.coords.accuracy);
            var now = new Date();
            var attributes = {};
        ...
        //} else {
        //    konsole.log("Point not added due to low accuracy  : " + location.coords.accuracy);
        //}
        //});
...
function locationError(error) {
    switch (error.code) {
        case error.PERMISSION_DENIED:
            ...
            //    id: "warning",
            //    title: 'Attention !',
            //    message: 'Location not provided.Please try again later.',
            //    cancelButton: 'Skip',
            //    continueButton: 'Wait',
        ...
        case error.POSITION_UNAVAILABLE:
            ...
            //    id: "warning",
            //    title: 'Attention!',
            //    message: 'Location not available.Please try again later.',
            //    cancelButton: 'Skip',
            //    continueButton: 'Wait',
